...
def get_public_transp(public_transport):
    ...
    df_public_transport.to_csv('../livablestreets/data/mobility_public_transport.csv', index=False)
...
def get_bike_infraestructure(bike_infraestructure):
    ...
    df_bike_infraestructure.to_csv('../livablestreets/data/mobility_bike_infraestructure.csv', index=False)
...
def get_eating(eating):
    ...
    df_eating.to_csv('../livablestreets/data/social_eating.csv', index=False)
    return df_eating
...
def get_night_life(night_life):
    ...
    df_night_life.to_csv('../livablestreets/data/social_night_life.csv', index=False)
...
def get_culture(culture):
    ...
    df_culture.to_csv('../livablestreets/data/social_culture.csv', index=False)
    return df_culture
...
def get_community(community):
    ...
    df_community.to_csv('../livablestreets/data/social_community.csv', index=False)
    return df_community
...
def get_health_care(health_care):
    ...
    df_health_care.to_csv('../livablestreets/data/activities_health_care.csv', index=False)
...
def get_public_service(public_service):
    ...
    df_public_service.to_csv('../livablestreets/data/activities_public_service.csv', index=False)
...
def get_education(education):
    ...
    df_education.to_csv('../livablestreets/data/activities_education.csv', index=False)
    return df_education
...
def get_economic(economic):
    ...
    df_economic.to_csv('../livablestreets/data/activities_economic.csv', index=False)
    return df_economic
...
def get_comfort_sports(comfort_sports):
    ...
    df_comfort_sports.to_csv('../livablestreets/data/comfort_sports.csv', index=False)
...
def get_all():
    ...
    get_eating(eating)
    get_night_life(night_life)
    get_culture(culture)
    get_community(community)
    get_health_care(health_care)
    get_public_service(public_service)
    get_education(education)
    get_economic(economic)
    get_comfort_sports(comfort_sports)
